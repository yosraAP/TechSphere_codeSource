            ...
            <div class="container">
                ...
                <div class="order-lg-2">
                    <button type="button" class="btn position-relative">
                        <form action="TraitementLangue">
                            <select class="form-select border-0 mt-3 mb-3" name="langue" onchange="submit()">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block justify-content-center">
                            <a class="btn btn-outline-light p-2" href="TraitmentDonnees?action=afficherProduct"><fmt:message key="index.titre1"/></a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block justify-content-center ">
                            <h5 class="display-3 text-center text-light">Techno - Shop</h5>
                            <a class="btn btn-outline-light p-2" href="TraitmentDonnees?action=afficherProduct"><fmt:message key="index.titre1"/></a>
                        </div>
                    </div>
                </div>
