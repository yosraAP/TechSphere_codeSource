...
<html>
    <head>
        ...
        <title>Update_Mot_de_Passe</title>
    ...
    <body>
        ...
        <div class="container d-flex justify-content-center align-content-center mt-5">
            <div class="update_pwd">
                <form name="maForm" action="TraitmentUser" method="POST">
                    <table>
                        <tr class="text-center">
                            <td colspan="2">
                                <p class="text-center"><img src="images/user-lock.svg.png"></p>
                                <h2 class="section-title text-center text-uppercase"><fmt:message key="changerMotdepasse.h2"/></h2>
                            </td>
                        </tr>
                        <tr>
                            <td class="mx-3 link-dark p-2"><fmt:message key="changerMotdepasse.nom"/></td>
                            <td><input class="border-0" type="text" name="userName" value="" /></td>
                        </tr>
                        <tr>
                            <td class="mx-3 link-dark p-2"><fmt:message key="changerMotdepasse.pwd"/></td>
                            <td><input class="border-0" type="password" name="nPwd" value="" /></td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center"><input class="btn_log" type="submit" value="<fmt:message key="btnMaj"/>" name="action" /></td>
                        </tr>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-center"><a class="link fw-bold text-decoration-none" href="login.jsp"><fmt:message key="nav.a4"/></a></td>
                        </tr>
                    </table>
                </form>
            </div>
